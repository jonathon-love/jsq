...
bcontTablesOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "bcontTablesOptions",
...
bcontTablesResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "bcontTablesResults",
...
bcontTablesBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "bcontTablesBase",
