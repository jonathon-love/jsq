...
bcorrMatrixOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "bcorrMatrixOptions",
...
bcorrMatrixResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
bcorrMatrixBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "bcorrMatrixBase",
